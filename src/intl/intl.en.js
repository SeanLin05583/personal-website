export default {
  ...
  'about.me.position.title': 'Position：',
  'about.me.position.description': 'Front-end Developer',
  'about.me.education.title': 'Education：',
  'about.me.education.description': 'National University of Kaohsiung',
  'about.me.major.title': 'Major：',
  'about.me.major.description': 'Computer Science and Information Engineering',
  'skill.title': 'Skills',
  ...
  'experience.leo.job.title': 'System Engineer / Front-end Developer',
  'experience.leo.job.maintain':
    'Maintain internal ERP, CRM system, including basic SQL operation, old system bug fix, new feature with HTML/CSS/JavaScript.',
  'experience.leo.job.develop':
    'Design and develop a work dispatch system for internal hardware-maintenance engineer, including map tracing, online work sheet fill-in, picture upload etc. , using React.js as front-end framework, and integrate with back-end RESTful API.',
