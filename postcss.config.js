  ...
  plugins: [
    ...
    require('postcss-mixins')({
      mixins: {
        ...
        isPad: overrideAtRule(
          `media screen and (min-width: ${breakpoint.mobileBreakPoint + 1}px) and (max-width: ${
            breakpoint.padBreakPoint
          }px)`
        ),
        isPc: overrideAtRule(`media screen and (min-width: ${breakpoint.padBreakPoint + 1}px)`),
      },
    }),
